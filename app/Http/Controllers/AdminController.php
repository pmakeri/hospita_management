...
class AdminController extends Controller
{
    ...
    public function upload(Request $request){
        ...
        $destinationPath = public_path('doctorsImages/');
    ...
    public function editdoctor(Request $request, $id){
        ...
        return redirect('showdoctor')->with('message', 'Update is Successful');
    }
    ...
    public function sendemail(Request $request, $id){
        ...
        Notification::send($data, new EmailNotification($details)); //The EmailNotification is the Notification file Name
